...
public class CarPark_Tests {
    ...
    public void testEquals() {
        ...
        CarPark carPark1 = new CarPark("K1", 27, 0, 0, "Childcare pickup/dropoff", new
                LatLng(-35.240708, 149.086687), new PolygonOptions().addAll(coords));
        CarPark carPark2 = new CarPark("K1", 27, 0, 0, "Childcare pickup/dropoff", new
                LatLng(-35.240708, 149.086687), new PolygonOptions().addAll(coords));
        Assert.assertEquals(carPark1, carPark2);
        coords.remove(0);
        CarPark carPark3 = new CarPark("K1", 27, 0, 0, "Childcare pickup/dropoff", new
                LatLng(-35.240708, 149.086687), new PolygonOptions().addAll(coords));
